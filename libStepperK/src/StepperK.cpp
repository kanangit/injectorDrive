...
/*
 * DirStep constructor.
 * Sets which wires should control the driver.
 */

DirStep::DirStep(int number_of_steps, int motor_pin_1, int motor_pin_2)
{
 ...
 */
void DirStep::setSpeed(long whatSpeed)
{
 ...
 */
void DirStep::step(int steps_to_move)
{
